  ...
  return (
    <div className="mt-16">
      <div className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        >
          {/* Bangla headline */}
          <h1 className="font-bangla text-5xl sm:text-6xl md:text-7xl font-extrabold mb-8 leading-tight">
            ঘর শুধু দেয়াল নয়,<br className="hidden sm:block" /> এটি আপনার গল্পের শুরু
          </h1>

          {/* Bangla subheadline */}
          <p className="font-bangla text-xl md:text-2xl leading-relaxed font-medium">
            আমরা শুধু একটি প্রপার্টি প্ল্যাটফর্ম নই—স্বপ্নের বাড়ি খুঁজে পাওয়ার প্রতিটি ধাপে আপনার বিশ্বস্ত সহযাত্রী।
          </p>
