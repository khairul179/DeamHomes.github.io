      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            ...
            >
              <img src={logo} alt="DreamHomes logo" className="w-6 h-6 brightness-0 invert" />
              {/* Floating sparkles */}
              <motion.div
                  ...
                  <div className="relative" ref={dropdownRef}>
                    ...
                    <AnimatePresence>
                      {isDropdownOpen && (
                        ...
                        >
                          {/* Header */}
                          // Header (Updated for improved styling)
                          <header className="fixed w-full bg-white shadow-lg z-10">
                            <nav className="flex justify-between items-center p-4 max-w-7xl mx-auto">
                              <div className="flex items-center space-x-4">
                                <img src="/assets/logo.png" alt="Logo" className="h-8" />
                                <ul className="hidden md:flex space-x-6">
                                  <li><a href="#home" className="text-gray-900 hover:text-blue-600 transition-all">Home</a></li>
                                  <li><a href="#properties" className="text-gray-900 hover:text-blue-600 transition-all">Properties</a></li>
                                  <li><a href="#about" className="text-gray-900 hover:text-blue-600 transition-all">About</a></li>
                                  <li><a href="#contact" className="text-gray-900 hover:text-blue-600 transition-all">Contact</a></li>
                                </ul>
