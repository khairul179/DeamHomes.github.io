...
<a href="https://DreamHomes.vercel.app" target="_blank">![Live Demo](https://waveify.onrender.com/api/badge?label=🚀+LIVE+DEMO&message=Visit+Site&color=purple&style=3d)</a>
...
<details>
  ...
  <p><strong>DreamHomes</strong> features expertly crafted animations powered by <strong>Framer Motion</strong> that enhance user engagement:</p>
...
![Git Clone Demo](https://waveify.onrender.com/api/terminal/github-dark?commands=[%22git%20clone%20https://github.com/AKHAIRUL412/Real-Estate-Website.git%22,%20%22cd%20Real-Estate-Website%22,%20%22ls%20-la%22]&width=700&height=450)
...
VITE_ADMIN_APP_NAME=DreamHomes Admin
```
