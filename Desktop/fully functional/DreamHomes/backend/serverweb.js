  ...
  return `<!DOCTYPE html>
    <html lang="en">
      <head>
        ...
        <title>DreamHomes API - Backend Dashboard</title>
        ...
        <div class="dashboard">
          ...
          <div class="content">
            ...
            <div class="info-section">
              ...
              <p>DreamHomes is a comprehensive real estate platform that combines modern web technologies with AI-powered property analysis to deliver an exceptional user experience.</p>
          ...
          <div class="footer">
            <p>© ${new Date().getFullYear()} DreamHomes. All rights reserved. | 
            <a href="/health">Health Check</a> | 
            <a href="/status">API Status</a> | 
            <a href="https://github.com/AKHAIRUL412/Real-Estate-Website" target="_blank">GitHub</a></p>
