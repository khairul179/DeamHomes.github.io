...
const StructuredData = ({ type, data }) => {
  ...
  const currentUrl = `https://DreamHomes.vercel.app${location.pathname}`;
  ...
  const schemas = {
    website: {
      ...
      '@type': 'WebSite',
      name: 'DreamHomes',
      url: 'https://DreamHomes.vercel.app',
      potentialAction: {
        '@type': 'SearchAction',
    ...
    organization: {
      ...
      name: 'DreamHomes',
      url: 'https://DreamHomes.vercel.app',
      logo: 'https://DreamHomes.vercel.app/logo.png',
      sameAs: [
        'https://github.com/AKHAIRUL412/Real-Estate-Website',
        'https://linkedin.com/in/AKHAIRUL412'
      ]
    },
    property: {
      '@context': 'https://schema.org',
    ...
    aiHub: {
      ...
      url: 'https://DreamHomes.vercel.app/ai-property-hub',
      offers: {
        '@type': 'Offer',
        price: '0',
        priceCurrency: 'INR',
