...
const AIPropertyHub = () => {
  ...
  useEffect(() => {
    ...
    document.title =
      "AI Property Hub | DreamHomes - Real Estate Market Analysis";
  }, []);
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                      <a
                        href="https://github.com/AKHAIRUL412/Real-Estate-Website"
                        target="_blank"
                      ...
                      <a
                        href="https://github.com/AKHAIRUL412/Real-Estate-Website/archive/refs/heads/main.zip"
